...
import { StyleSheet, View, FlatList, Image, Text, TouchableOpacity, TouchableHighlight } from 'react-native'
...
function NormalProfileScreen({ navigation }) {
  ...
  return (
    ...
    >
      ...
      <TouchableHighlight style={{
        ...
        <View style={{
          paddingRight: 5, alignItems: 'center',
          flexDirection: 'row'
        }}>
      ...
      {/* <TouchableOpacity style={{
        ...
        onPress={() => navigation.navigate('AccountsUpdate')}
      >
