...
import NormalDiseaseDetailsCard from '../components/NormalDiseaseDetailsCard';

function NormalDiseaseDetailsScreen({ navigation, route }) {
...
export default NormalDiseaseDetailsScreen
