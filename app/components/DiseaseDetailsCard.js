      ...
      <ScrollView >
        <View style={styles.card}>
          <View style={styles.detailsContainer}>
            ...
            <View style={styles.row1}>
              {/* <Caption> */}
              <Caption style={styles.caption}>{sign1 + ', ' + sign2 + ', ' + sign3 + ' and ' + sign4}</Caption>
              {/* </Caption> */}
            </View>
            ...
            <View style={styles.row1}>
              {/* <Caption> */}
              <Caption style={styles.caption}>{createdBy}</Caption>
              {/* </Caption> */}
            </View>
